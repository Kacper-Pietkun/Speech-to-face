...
class VGGFace_rcmalli_vgg16(nn.Module):
    def __init__(self):
        super(VGGFace_rcmalli_vgg16, self).__init__()

        self.layers = []

        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer1)

        self.layer2 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(2,2), stride=(2,2))
        )
        self.layers.append(self.layer2)
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer3)

        self.layer4 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=(2,2), stride=(2,2))
        )
        self.layers.append(self.layer4)
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer5)

        self.layer6 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer6)
        ...
        self.layer8 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=512, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer8)

        self.layer9 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=(3,3), stride=1, padding=1, padding_mode="same"),
            nn.ReLU()
        )
        self.layers.append(self.layer9)
